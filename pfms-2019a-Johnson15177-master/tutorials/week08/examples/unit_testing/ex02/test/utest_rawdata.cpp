...
TEST(Laser, ValidResolution) {
    Laser l;
    EXPECT_TRUE(l.setAngularResolution(10));
    EXPECT_TRUE(l.setAngularResolution(30));
}

TEST(Laser, InvalidResolution) {
    Laser l;
    int res = l.getAngularResolution();
    EXPECT_FALSE(l.setAngularResolution(40));
    ASSERT_EQ(l.getAngularResolution(), res);
}
